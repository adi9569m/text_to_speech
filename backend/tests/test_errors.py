...
def test_error_exceeds_max_length():
    """Text > 1000 characters should return 422 Unprocessable Entity."""
    long_text = "x" * 1001
...
def test_error_invalid_voice():
    """Requesting an unsupported voice should return 400 Bad Request."""
...
def test_error_delete_nonexistent_history():
    """Deleting non-existent history record should return 404 Not Found."""
...
def test_error_favorite_nonexistent_history():
    """Toggling favorite on non-existent history record should return 404 Not Found."""
...
def test_error_nonexistent_route():
    """Accessing an invalid route should return 404 Not Found."""
    response = client.get("/api/invalid_endpoint_does_not_exist")
    assert response.status_code == 404


def test_error_method_not_allowed():
    """Using an incorrect HTTP method should return 405 Method Not Allowed."""
